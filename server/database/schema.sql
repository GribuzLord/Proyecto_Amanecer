...
CREATE TABLE partes_programa (
  ...
  grupo_custom  VARCHAR(60) NULL COMMENT 'ID de agrupación para partes dinámicas',
  orden         INT NOT NULL DEFAULT 0,
...
('custom_maestros',       'maestros',       'Asignación Dinámica',                TRUE,  TRUE,  'ninguna', 8),
...
('custom_vida_cristiana', 'vida_cristiana', 'Participación Dinámica',             FALSE, FALSE, 'ninguna', 13),
('presidente_atalaya',    'atalaya',        'Presidente Estudio de la Atalaya',   FALSE, FALSE, 'M', 14),
('conductor_atalaya',     'atalaya',        'Conductor',                          FALSE, FALSE, 'M', 15),
('lector_atalaya',        'atalaya',        'Lector',                             FALSE, FALSE, 'M', 16),
('oracion_final_atalaya', 'atalaya',        'Oración Final',                      FALSE, FALSE, 'M', 17);
